...
// and not as code
func (viewHelper *ViewHelper) UnescapeString(s string) string {
	return html.UnescapeString(s)
}

// ToInt converts a 64 bit float value to a displayble integer value
func (viewHelper *ViewHelper) ToInt(value float64) int {
	return int(value)
}

// ToMoney converts a 64 bit float value to a displayble money value
func (viewHelper *ViewHelper) ToMoney(value float64) string {
...
func (viewHelper *ViewHelper) DurationToSeconds(timeMilli int) string {
